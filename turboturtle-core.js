...
// --- 2. PARALLAX TWEENS ---
      ...
      tweenIf(".about_giant_squid", stable({ x: () => 5 * vw, y: () => 120 * vh, rotation: -5, ease: "none", scrollTrigger: { trigger: ".about_giant_squid", start: "top bottom", end: "bottom -120%", scrub: true } }));
