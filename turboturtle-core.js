...
// --- 2. PARALLAX TWEENS ---
      ...
      tweenIf(".about_balloon", stable({ y: () => 250 * vh, ease: "power2.out", scrollTrigger: { trigger: ".about_balloon", start: "top bottom", end: "bottom -100%", scrub: true } }));
...
// --- 2.4. CITY LAYER REVEALS ENGINE (Ease Out 減速收尾 + 滾動緩衝) ---
      ...
      var cityReveals = [
        ...
        { sel: ".about_moutain",         from: { y: "35vh" },  to: { y: "0vh" }, start: "100%", end: "30%" },
