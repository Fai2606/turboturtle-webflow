...
(function (root) {
  ...
  function startWhenReady(tries) {
    ...
    if (tries > 0) {
      setTimeout(function () {
        startWhenReady(tries - 1);
      }, 100);
    } else {
      console.error(
        "[TT] Required libs not available (GSAP/ScrollTrigger/Lenis)."
      );
    }
  }
  ...
  function startCore() {
    try {
      ...
      function stable(vars) {
        ...
        if (vars.scrollTrigger.scrub === true) {
          vars.scrollTrigger.scrub = 1;
        }

        if (!vars.scrollTrigger.start) {
          vars.scrollTrigger.start = "top 120%";
        }
      ...
      if (exists("#liquid-stream") && MorphSVGPlugin) {
        var drippedPath =
          "M395,120 C380,250 370,400 395,520 C400,530 400,530 405,520 C430,400 420,250 405,120 Z";
      ...
      // -------------------------------------------------------------
      // ABOUT US — Main Parallax
      // -------------------------------------------------------------
      tweenIf(
        ".about_planet",
        stable({
          targetEl: ".about_planet",
          y: function () {
            return 20 * vh;
          },
          ease: "none",
      ...
      tweenIf(
        ".about_small_planet1",
        stable({
          targetEl: ".about_small_planet1",
          y: function () {
            return 10 * vh;
          },
          ease: "none",
          scrollTrigger: {
            trigger: ".about_small_planet1",
            start: "top bottom",
            end: "bottom top",
            scrub: 1
          }
      ...
      tweenIf(
        ".about_small_planet2",
        stable({
          targetEl: ".about_small_planet2",
          y: function () {
            return 15 * vh;
          },
          ease: "none",
          scrollTrigger: {
            trigger: ".about_small_planet2",
            start: "top bottom",
            end: "bottom top",
            scrub: 1
          }
      ...
      tweenIf(
        ".footer_credit",
        stable({
          targetEl: ".footer_credit",
          y: function () {
            return 10 * vh;
          },
          ease: "none",
          scrollTrigger: {
            trigger: ".footer_credit",
            start: "top bottom",
            end: "bottom top",
            scrub: 1
          }
      ...
      // -------------------------------------------------------------
      // ABOUT US — City Layer Reveals
      // -------------------------------------------------------------
      var mountainTrigger = exists(".about_mountain")
        ? ".about_mountain"
        : ".about_bottom_area";
      ...
      if (jet) {
        ScrollTrigger.create({
          ...
          onUpdate: function (self) {
            ...
            var prevRot = parseFloat(
              jet.dataset.prevRot || "0"
            );
      ...
      var vids = document.querySelectorAll(
        ".about_onceupon video, video[data-pause-offscreen]"
      );
...
function initHomeSection2() {
  ...
  // Webflow position = middle/reference position
  ...
  // Trigger when it reaches about 30% from bottom
  // =============================================================
  ...
  // =============================================================
  // OTHER OBJECT HEADS-UP ANIMATIONS
  // =============================================================
