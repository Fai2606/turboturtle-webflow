...
(function (root) {
  ...
  function startCore() {
    ...
    try {
      ...
      tweenIf(".spacecats", {
        x:-3*vw, y:55*vh, rotation:20, scale:1.1, ease:"none",
        scrollTrigger:{ trigger: parallaxTrigger, start:"top top", end:"bottom bottom", scrub:true }
      });

      tweenIf(".about_saturn", {
        x:-2*vw, y:30*vh, rotation:-25, scale:0.9, ease:"none",
        scrollTrigger:{ trigger: parallaxTrigger, start:"top top", end:"bottom bottom", scrub:true }
      });

      tweenIf(".satellitemove", {
        x:10*vw, y:50*vh, rotation:15, scale:0.85, ease:"none",
        scrollTrigger:{ trigger: parallaxTrigger, start:"top top", end:"bottom bottom", scrub:true }
      });
      ...
      tweenIf(".about_section_1", { // Not present in your current DOM, safe guard
        y:-10*vh, ease:"none",
        scrollTrigger:{ trigger: parallaxTrigger, start:"top top", end:"bottom bottom", scrub:true }
      });
      ...
      tweenIf(".about_rocket", { // Not present now, guard
