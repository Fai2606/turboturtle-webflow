...
        { sel: ".about_eyetower",        from: { y: "90vh" }, to: { y: "0vh" }, start: "100%", end: "35%" },
        { sel: ".about_citytree_1",      from: { y: "50vh" },  to: { y: "0vh" }, start: "100%", end: "30%" },
        { sel: ".about_citytree_2",      from: { y: "50vh" },  to: { y: "0vh" }, start: "100%", end: "30%" },
        { sel: ".about_citytree_3",      from: { y: "50vh" },  to: { y: "0vh" }, start: "100%", end: "30%" },
